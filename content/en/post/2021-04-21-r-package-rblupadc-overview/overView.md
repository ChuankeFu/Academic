...
Finally, we kindly provided an easier way of applying `blupADC`, which is a free  website([see more details](https://qsmei.netlify.app/post/2021-04-22-blupadc-online-dmu/online_dmu/)).  Most functions of  package`blupADC`  can be found in this website. Thus, for user who have little code experience, we recommend  to use this website(**only need to click and type, that's enough**).  But the pitfall of this website is that it can't handle big data. 
...
-   Feature 2. Detect duplicated genotype data
-   Feature 3. Trace, rename and correct pedigree
-   Feature 4. Quality control and imputation
-   Feature 5. Construct kinship matrix
-   Feature 6. Interaface with DMU
-   Feature 7. Interaface with BLUPF90
